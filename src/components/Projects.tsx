        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {Setting.getUserData().Projects.map((project, index) => (
            <LazySection
              ...
              delay={index * 100}
              fallback={
                <div className="w-full h-96 bg-gray-200 dark:bg-gray-700 animate-pulse rounded-xl" />
              }
            >
              <motion.div
                ...
                className="w-full overflow-hidden transition-all duration-300 rounded-xl border-l-4 border-primary hover:border-l-0 cursor-default bg-slate-100/40 dark:bg-slate-700/40 backdrop-blur-sm shadow-lg hover:shadow-xl"
              >
